...
public class KnuthManulEng extends JFrame implements ActionListener {

    JLabel typeCandidate,maxNumber,itemsToDraw, successDraw, fileCreated;
    JPanel panel;
    ...
    public KnuthManulEng() {
        
        f = new JFrame();
        f.setLayout(null);
        f.setTitle("Durstenfeld-Knuth Shuffle (manually provided input)");
  ...
  public void decreaseNumberOfSelection(JTextField jtf){
        ...
        if (e.getSource() == save) {
            ...
            if (answer == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Logger.getLogger(KnuthManulEng.class.getName()).log(Level.SEVERE, null, ex);
                } finally {
    ...
    public static void main(String[] args) {
        ...
        KnuthManulEng n = new KnuthManulEng();
