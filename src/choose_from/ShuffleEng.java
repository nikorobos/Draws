...
public class ShuffleEng extends JFrame implements ActionListener {
    ...
    ShuffleEng() {
        ...
        fileCreated.setBounds(127, 327, 357, 30);
        ...
        if (e.getSource() == save) {
            ...
            if (answer == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    ...
                    Logger.getLogger(ShuffleEng.class.getName()).log(Level.SEVERE, null, ex);
                } finally {
